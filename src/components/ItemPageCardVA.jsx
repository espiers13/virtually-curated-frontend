...
function ItemPageCardVA({
  ...
  let artistMaker = "";
  let title = "No Title";
  let images = currentItemImages;

  if (artistMakerOrganisations) {
    artistMaker = artistMakerOrganisations.name.text;
  }
  if (artistMakerPeople) {
    artistMaker = artistMakerPeople.name.text;
  }
  if (artistMakerPerson) {
    artistMaker = artistMakerPerson.name.text;
  }

  if (currentItemTitle.length > 0) {
    title = currentItemTitle[0].title;
  }
  ...
  return (
    <main className="flex mt-5 p-5 w-full place-content-center">
      <div className={itemPageStyling}>
        <div>
          <ItemCardImages currentItemImages={images} imgStyle={imgStyle} />
        </div>
        <h1 className={headerStyling}>{title}</h1>
        <h1 className={h2Styling}>{artistMaker}</h1>
        <p className={h2Styling}>{summaryDescription}</p>
          ...
          <table className={tableStyling}>
            <tbody>
              <tr className={lineStyling}>
                ...
                <td className={dataStyling}>{objectType}</td>
              </tr>
              <tr className={lineStyling}>
                <th scope="row" className={titleStyling}>
                  DATE PRODUCED
                </th>
                <td className={dataStyling}>{productionDates}</td>
              </tr>
              <tr className={lineStyling}>
                <th scope="row" className={titleStyling}>
                  PHYSICAL DESCRIPTION
                </th>
                <td className={dataStyling}>{physicalDescription}</td>
              </tr>
              <tr className={lineStyling}>
                <th scope="row" className={titleStyling}>
                  BRIEF DESCRIPTION
                </th>
                <td className={dataStyling}>{briefDescription}</td>
              </tr>
              <tr className={lineStyling}>
                <th scope="row" className={titleStyling}>
                  OBJECT HISTORY
                </th>
                <td className={dataStyling}>{objectHistory}</td>
              </tr>
              <tr className={lineStyling}>
                <th scope="row" className={titleStyling}>
                  MATERIALS AND TECHNIQUES
                </th>
                <td className={dataStyling}>{materialsAndTechniques}</td>
              </tr>
            </tbody>
          </table>
        </div>
